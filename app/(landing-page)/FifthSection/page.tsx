            ...
            <div className=" space-y-6 flex flex-col text-gray-200 md:w-1/3 px-10 ">
                ...
                <Accordion type="single" collapsible>
                    ...
                    <AccordionItem value="item-3">
                        ...
                        <AccordionContent className="border-b border-yellow-400">
                            Get real-time insisghts into progress for any workstream.
                            <div className="flex text-yellow-300 pt-4">
                                <div className="text-lg">Get Started</div>
                                <ArrowRight className="h-6 w-6 ml-4" />
                            </div>
                        </AccordionContent>
                    ...
                    <AccordionItem value="item-4">
                        <AccordionTrigger className="text-green-300">
                            Manage your intakes
                        </AccordionTrigger>
                        <AccordionContent>
                            Make it easy to collect information and triage incoming requests.
                            <div className="flex text-green-300 pt-4">
                                <div className="text-lg">Get Started</div>
                                <ArrowRight className="h-6 w-6 ml-4" />
                            </div>
                        </AccordionContent>
